...
with open('src/defaults/default_preamble.tex') as file:
...
def create_image_from_tex(expression: str, filename: str):
    ...
    if filename.endswith('.png'):
        os.system(f'magick   -density 300 tempfolder/outfile.pdf -trim +repage -bordercolor none -border 10 -quality 100 {filename}')
